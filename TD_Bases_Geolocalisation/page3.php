...
<head>
	...
	<link rel="stylesheet" href="lib/locate/dist/L.Control.Locate.min.css" />
...
<body>
	<center>
		...
		<center>
			...
			<div id='actions'><a class="text-warning" href='#'>Géolocalisation</a></div>
	...
	<script src="lib/locate/L.Control.Locate.js" ></script>
	<script>
	...
	function onLocationFound(e) {
	   ...
	   L.marker(location,{icon: orangeIcon}).addTo(map)
	}
